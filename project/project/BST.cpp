...
template <class Type>
void ADTNode::setData(Type d) {
  data = d;
}

template <class Type>
void Type ADTNode::getData() {
  return data;
}
...
template <class Type>
ADTNode<Type>* BST::leftBalance(ADTNode<Type>* subRoot) {
...
template <class Type>
ADTNode<Type>* BST::rightBalance(ADTNode<Type>* subRoot) {
...
template <class Type>
ADTNode<Type>* BST::rotateLeft(ADTNode<Type>* subRoot) {
...
template <class Type>
ADTNode<Type>* BST::rotateRight(ADTNode<Type>* subRoot) {
...
template <class Type>
int BST::getHeight(ADTNode<Type>* subRoot) {
  if (subRoot == nullptr){
      return 0;
  }
